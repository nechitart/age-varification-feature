...
class Config
{
    const IS_ENABLE_PATH = 'lachestry_ageverification/settings/enable';
    const VERIFICATION_AGE_PATH = 'lachestry_ageverification/settings/verification_age';
    const CUSTOMER_EMAIL_TEMPLATE_PATH = 'lachestry_ageverification/notifications/customer_notification';
